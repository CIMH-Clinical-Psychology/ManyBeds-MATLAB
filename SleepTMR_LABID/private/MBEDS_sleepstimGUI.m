...
%%%
sndVolGroup = uibuttongroup('Units','pixels','Position',[70, 170, 110, 60],'Title','Sound Volume');
...
bgVolGroup = uibuttongroup('Units','pixels','Position',[70, 100, 110, 60],'Title','Background Volume');
